...
def main(args):
    ...
    kb = add_KB(num_classes=args.num_classes,num_digits=args.digit_size)
    ...
    bridge.train(train_data, epochs=args.epoches, batch_size=10, test_data=test_data)
    end_time=time.time()
...
def get_args():
    ...
    parser.add_argument("--test_sequence_num", type=int, default=100)
